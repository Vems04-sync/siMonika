    ...
    <div class="main-content">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-info"
                                            onclick="showAtributDetail({{ $atribut->id_atribut }})">
        ...
        <div class="modal fade" id="tambahAtributModal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="atributForm" action="{{ route('atribut.store') }}" method="POST">
                        @csrf
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="tipe_data" class="form-select" required>
                                    ...
                                    <option value="varchar">Text (Pendek)</option>
                    ...
                    <form id="editAtributForm" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="" id="edit_aplikasi_nama"
                                    disabled>
        ...
        <div class="modal fade" id="detailAtributModal" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="detailAtributTitle">Detail Atribut</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <div class="table-responsive">
                            <table class="table" id="detailAtributTable">
                                <thead>
                                    <tr>
                                        <th>Nama Aplikasi</th>
                                        <th>Nilai Atribut</th>
