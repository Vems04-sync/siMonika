...
<body>
    ...
    $(document).ready(function() {
        ...
        function updateNilaiAtribut(aplikasiId, nilaiAtribut) {
            ...
            console.log('Updating nilai atribut:', { aplikasiId, nilaiAtribut, currentAtributId });
        ...
        function updateNilaiAtribut(aplikasiId, nilaiAtribut) {
            $.ajax({
                ...
                error: function(xhr) {
                    ...
                    toastr.error(xhr.responseJSON?.message || 'Terjadi kesalahan saat mengupdate nilai atribut');
                }
            });
        }
    });
